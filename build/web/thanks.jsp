...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="vi" class="loading-site no-js"> <!--<![endif]-->
    <head>
        <meta charset="UTF-8" />
        <script type="text/javascript" nonce="78eb0f8ad302413991e8ccbabf0" src="//local.adguard.org?ts=1645338361898&amp;type=content-script&amp;dmn=shop.mixigaming.com&amp;app=chrome.exe&amp;css=1&amp;js=1&amp;gcss=1&amp;rel=1&amp;rji=1&amp;sbe=0&amp;stealth=1&amp;uag="></script>
        <script type="text/javascript" nonce="78eb0f8ad302413991e8ccbabf0" src="//local.adguard.org?ts=1645338361898&amp;name=AdGuard%20Popup%20Blocker&amp;name=AdGuard%20Extra&amp;type=user-script"></script><link rel="profile" href="https://gmpg.org/xfn/11" />
    ...
    <body data-rsssl=1 class="page-template-default page page-id-53 theme-flatsome woocommerce-checkout woocommerce-page woocommerce-no-js header-shadow lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border">
        ...
        <div id="wrapper">
            ...
            <main id="main" class="">
                ...
                <div> <br>  </div>
                    ...
                    <div class="row"  id="row-1910214969">


                        <div id="col-1998370221" class="col small-12 large-12"  >
                            <div class="col-inner"  >
                                <section class="section dark" id="section_1145649153">
                                    <div class="bg section-bg fill bg-fill bg-loaded">

                                        <div class="video-overlay no-click fill visible"></div>
                                        <video class="video-bg fill visible" preload="" playsinline="" autoplay="" muted="" loop="" __idm_id__="4186113">
                                            <source src="img/videobanner.mp4" type="video/mp4">	</video>
                                    ...
                                    <div class="section-content relative">
                                        ...
                                        <div class="row row-collapse" id="row-1698203051">


                                            <div id="col-1238903449" class="col small-12 large-12">
                                                <div class="col-inner text-center">



                                                    <h1 style="font-weight: bold">ĐẶT HÀNG THÀNH CÔNG <br/> MIXIBOOK CẢM ƠN</h1>

                                                    <a rel="noopener noreferrer nofollow" href="home" target="_blank" class="button white is-small">
                                                        <span>TRANG CHỦ</span>
                                                    </a>


                                                    <a rel="noopener noreferrer nofollow" href="product" target="_blank" class="button white is-outline is-small">
                                                        <span>SẢN PHẨM</span>
                                                    </a>
                                    ...
                                    <style>
                                        ...
                                        #section_1145649153 .section-bg-overlay {
                                            background-color: rgba(0, 0, 0, 0.35);
                                        }
                                        #section_1145649153 .section-bg.bg-loaded {
