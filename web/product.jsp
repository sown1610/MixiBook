<%-- 
    Document   : product
    Created on : Feb 26, 2022, 4:14:09 PM
    Author     : Sown
--%>
...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="vi" class="loading-site no-js"> <!--<![endif]-->
    ...
    <body data-rsssl=1 class="home page-template page-template-page-blank page-template-page-blank-php page page-id-89 theme-flatsome woocommerce-no-js header-shadow lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border">
        ...
        <div id="wrapper">
            ...
            <main id="main" class="">
                ...
                <div id="content" role="main" class="content-area">
                    ...
                    <div class="banner has-hover" id="banner-1707099471">
                    ...
                    <!--                    <div class="shop-page-title category-page-title page-title ">
                                            <div class="page-title-inner flex-row  medium-flex-wrap container">
                                                <div class="flex-col flex-grow medium-text-center">
                                                    ...
                                                    <h1 class="shop-page-title is-xlarge">${g.genreName}</h1>
                                                ...
                                                <div class="flex-col medium-text-center">
                                                    ...
                                                    <form class="woocommerce-ordering" method="get">
                                                        <select name="orderby" class="orderby" aria-label="Đơn hàng của cửa hàng">
                                                            ...
                                                            <option value="product"  selected='selected'>Mới nhất</option>
                        ...
                        <div class="col large-3 hide-for-medium ">
                            <div id="shop-sidebar" class="sidebar-inner col-inner">
                                <aside id="woocommerce_price_filter-9" class="widget woocommerce widget_price_filter">
                                    ...
                                    <!--                                    <form method="get" action="https://shop.mixigaming.com/danh-muc/ao-mixi/">
                                                                            <div class="price_slider_wrapper">
                                                                                <div class="price_slider" style="display:none;"></div>
                                                                                <div class="price_slider_amount" data-step="10">
                                                                                    <input type="text" id="min_price" name="min_price" value="220000" data-min="220000" placeholder="Giá thấp nhất" />
                                ...
                                </aside><aside id="woocommerce_product_categories-13" class="widget woocommerce widget_product_categories"><span class="widget-title shop-sidebar">Danh mục sản phẩm</span><div class="is-divider small"></div><ul class="product-categories">
                                        <c:forEach  items="${listGenre}" var="g">
                                            <li class="cat-item cat-item-142"><a href="genre?genreID=${g.genreID}">${g.genreName}</a></li>
                                            </c:forEach>
                            ...
                            <div class="shop-container">
                                ...
                                <div class="woocommerce-notices-wrapper"></div><div class="products row row-small large-columns-3 medium-columns-3 small-columns-2">
                                    <c:forEach items="${all}" var="a">
                                        <div class="product-small col has-hover out-of-stock product type-product post-32017 status-publish first outofstock product_cat-ao-mixi has-post-thumbnail shipping-taxable purchasable product-type-variable">
                                            <div class="col-inner">
                                                ...
                                                <div class="product-small box ">
                                                    <div class="box-image">
                                                        <div class="image-fade_in_back">
                                                            <a href="detail?productID=${a.bookID}">
                                                                <img width="300" height="400" src="img/comic/${a.img}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Apcitylogoden" loading="lazy" /><img width="300" height="400" src="img/comic/hover.png" class="show-on-hover absolute fill hide-for-small back-image" alt="Vuvu4680" loading="lazy" />				</a>
                                                        </div>
                                                    ...
                                                    <div class="box-text box-text-products text-center grid-style-2">
                                                        <div class="title-wrapper">	 	
                                                            <p class="name product-title woocommerce-loop-product__title"><a href="https://shop.mixigaming.com/san-pham/ao-phong-mixicity-logo-be-den/" class="woocommerce-LoopProduct-link woocommerce-loop-product__link " style="font-weight: bold;font-size: initial">${a.bookName}</a></p></div><div class="price-wrapper">
                                                            <span class="price"><span class="woocommerce-Price-amount amount" style="font-style: italic;"><bdi>${a.price}00&nbsp;<span class="woocommerce-Price-currencySymbol">&#8363;</span></bdi></span></span>
                                                                        <c:choose>  
                                                                            <c:when test="${a.quantity == 0}"> 

                                                                    <a  class="button alt disabled" style=" background-color: #0a4da8"  >Sản phẩm đã hết hàng </a>
                                                                    <div class="product_meta">
                                                                    </div>
                                                                </c:when>
                                                                <c:otherwise>  
                                                                    <a  class="button alt " style=" background-color: #0a4da8" href="add-to-cart?productID=${a.bookID}" >Thêm vào giỏ hàng </a>
                                                                    <div class="product_meta">
                                                                    </div>
                                                                </c:otherwise>
                                                            </c:choose>  
                    ...
                    <nav aria-label="Page navigation example" class="d-flex justify-content-center">
                        <ul class="pagination " >
                            <li class="page-item ${page==1||page==null?"disabled":""}" ><a class="page-link " href="product?page=${page-1}">Trang Trước</a></li>
                                <c:forEach begin="1" end="${totalPage}" var="i">
                                <li class="page-item ${i==page?"active":""}"><a class="page-link" href="product?page=${i}">${i}</a></li>
                                </c:forEach>

                            <li class="page-item ${page==totalPage?"disabled":""}"><a class="page-link" href="product?page=${page+1}">Trang Sau</a></li>
                        </ul>
                    </nav>
            </main>
        ...
        <div id="main-menu" class="mobile-sidebar no-scrollbar mfp-hide">
            <div class="sidebar-menu no-scrollbar ">
                <ul class="nav nav-sidebar nav-vertical nav-uppercase">
                    ...
                    </li><li id="menu-item-230" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-230"><a href="home">MixiShop</a></li>
                    ...
                    <li id="menu-item-20084" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-20084"><a>ÁO</a>
                        <ul class="sub-menu nav-sidebar-ul children">
                            <li id="menu-item-7119" class="label-new menu-item menu-item-type-taxonomy menu-item-object-product_cat current-menu-item menu-item-7119"><a href="https://shop.mixigaming.com/danh-muc/ao-mixi/" aria-current="page">ÁO MIXI</a></li>
        ...
        <!-- Instagram Feed JS -->
        <script type="text/javascript">
            var sbiajaxurl = "https://shop.mixigaming.com/wp-admin/admin-ajax.php";</script>
                ...
                <div class="account-login-inner">
                    ...
                    <form class="woocommerce-form woocommerce-form-login login" method="post">
                        ...
                        <p class="form-row">
                            ...
                            <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce" value="4a17eb8052" /><input type="hidden" name="_wp_http_referer" value="/danh-muc/ao-mixi/" />						<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="Đăng nhập">Đăng nhập</button>
                        </p>
    ...
    <script type='text/javascript' id='wc-add-to-cart-js-extra'>
        /* <![CDATA[ */
        var wc_add_to_cart_params = {"ajax_url":"\/wp-admin\/admin-ajax.php", "wc_ajax_url":"\/?wc-ajax=%%endpoint%%", "i18n_view_cart":"Xem gi\u1ecf h\u00e0ng", "cart_url":"https:\/\/shop.mixigaming.com\/cart\/", "is_cart":"", "cart_redirect_after_add":"no"};
        /* ]]> */
    </script>
    ...
    <![endif]-->
    <script type='text/javascript' src='https://shop.mixigaming.com/wp-includes/js/jquery/ui/core.min.js' id='jquery-ui-core-js'></script>
    <script type='text/javascript' src='https://shop.mixigaming.com/wp-includes/js/jquery/ui/mouse.min.js' id='jquery-ui-mouse-js'></script>
    <script type='text/javascript' src='https://shop.mixigaming.com/wp-includes/js/jquery/ui/slider.min.js' id='jquery-ui-slider-js'></script>
    <script type='text/javascript' src='https://shop.mixigaming.com/wp-content/plugins/woocommerce/assets/js/jquery-ui-touch-punch/jquery-ui-touch-punch.min.js' id='wc-jquery-ui-touchpunch-js'></script>
    <script type='text/javascript' src='https://shop.mixigaming.com/wp-content/plugins/woocommerce/assets/js/accounting/accounting.min.js' id='accounting-js'></script>
    <script type='text/javascript' id='wc-price-slider-js-extra'>
        /* <![CDATA[ */
        var woocommerce_price_slider_params = {"currency_format_num_decimals":"0", "currency_format_symbol":"\u20ab", "currency_format_decimal_sep":".", "currency_format_thousand_sep":",", "currency_format":"%v\u00a0%s"};
        /* ]]> */
    </script>
    <script type='text/javascript' src='https://shop.mixigaming.com/wp-content/plugins/woocommerce/assets/js/frontend/price-slider.min.js' id='wc-price-slider-js'></script>
...
<!-- Cached page generated by WP-Super-Cache on 2022-02-26 16:06:03 -->
