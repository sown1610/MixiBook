...
<html lang="en">
    <head>
        ...
        <title>MixiBook - Sửa sản phẩm</title>
                        ...
                        <form action="editproduct" method="post">
                            ...
                            <div class="modal-body">					
                                <div class="form-group">
                                    <label>ID</label>
                                    <input value="${product.bookID}" name="id" type="number" class="form-control" readonly required>
                                </div>
                                <div class="form-group">
                                    <label>Tên</label>
                                    <input value="${product.bookName}" name="name" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Giá</label>
                                ...
                                <div class="form-group">
                                    <label>Tác giả</label>
                                    <input value="${product.author}" name="author" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Nhà xuất bản</label>
                                    <input value="${product.publisher}" name="publisher" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Ngày xuất bản</label>
                                    <input value="${product.publicDATE}" name="publicDATE" type="date" class="form-control" required>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Mô Tả</label>
                                    <textarea  name="desc" type="text" class="form-control" required cols="40" rows="5">${product.desc}</textarea>
                                </div>
