                    ...
                    <tbody>
                        <c:forEach items="${lp}" var="o">
                            <tr>
                                ...
                                <td>${o.bookName}</td>
                                <td>
                                    <img src="img/comic/${o.img}">
                                </td>
                                <td>${o.price}00 đ</td>
                                <td>
                                    <a href="loadproduct?id=${o.bookID}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="delete?id=${o.bookID}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                    ...
                    <form action="addproduct" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <input name="quantity" type="number" class="form-control" required></input>
                            </div>
                            <div class="form-group">
                                <label>Ảnh</label>
                            ...
                            <div class="form-group">
                                ...
                                <input name="publisher" type="text" class="form-control" required></input>
                            </div>
                            
                            <div class="form-group">
                                <label>Ngày xuất bản</label>
                                <input name="publishDATE" type="date" class="form-control" required></input>
                            </div>
                            
                            <div class="form-group">
                                <label>Mô tả</label>
                                <input name="desc" type="text" class="form-control" required></input>
                            </div>
                            <div class="form-group">
